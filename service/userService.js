...
const userLogin = async (uName, userPwd, res) => {
    ...
    if(uName && userPwd){
        ...
        if(currUser) {
            ...
            //await userModel.updateOne({uName, userPwd: currUser.userPwd}, {$set: {refreshToken: tokenData.refToken}});
...
module.exports = {createUser, userLogin, getAllUsers, logOutUser, saveUser, deleteUser};
